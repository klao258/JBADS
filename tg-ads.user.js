...
// @version      2025.05.25-0000   // ← 此字段将由 GitHub Actions 自动覆盖
...
// @require      https://klao258.github.io/JBADS/adsData/ZhaoShang.js
...
(function () {
    ...
    console.log('✅ TG广告脚本已加载');
    console.log('📌 当前版本为：将自动由 GitHub Actions 注入');
